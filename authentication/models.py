...
class User(AbstractUser):
    ...
    def createEndorser(self, tagline, followers, description=None, interests=None, location=None, social_media=None):
        from endorsers.models import Endorser
    ...
    def createOrganization(self, name, type, logo=None, description=None,  location=None, social_media=None):
...
class Review(models.Model):
    ...
    type = models.CharField(max_length=20, choices=[("organization","Organization"), ("endorser", "Endorser")])
    created_for = models.ForeignKey("authentication.User", on_delete=models.CASCADE, related_name="receiver")
    created_by = models.ForeignKey("authentication.User", on_delete=models.CASCADE, related_name="sender")
